        ...
        <div className="flex-1 overflow-y-auto px-4 pt-3 pb-8 space-y-4">
          ...
          <div className="flex items-center gap-3.5 py-1 px-1 overflow-x-auto no-scrollbar">
            ...
            <Link
              ...
              title="เพิ่มสัตว์เลี้ยงใหม่ (เข้าสู่ระบบ)"
            >
            ...
            <div className="flex items-center gap-2.5 pt-1 overflow-x-auto no-scrollbar pb-1">
              {activityButtons.map((btn) => (
                <button
                  ...
                  className="w-14 h-14 rounded-full bg-white border border-slate-100 shadow-[0_4px_12px_rgba(0,0,0,0.06)] active:scale-95 flex flex-col items-center justify-center transition-all shrink-0 hover:border-teal-300 relative"
          ...
          <div className="bg-white rounded-3xl p-4 border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.04)] text-left">
            ...
            <div className="space-y-2 text-[14px]">
              <div className="flex items-center justify-between py-1.5 border-b border-slate-100">
                ...
                <span className="font-semibold text-slate-400 text-[13px]">
